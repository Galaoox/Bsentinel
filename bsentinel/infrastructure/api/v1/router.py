...
from .auth import build_admin_dependency, build_auth_router, build_authenticated_dependency
...
from .stores import build_store_router
...
def build_v1_router(
    ...
    admin_dependencies = [Depends(build_admin_dependency(get_auth_service))]
    ...
    router.include_router(
        build_store_router(get_store_command_service, get_store_query_service),
